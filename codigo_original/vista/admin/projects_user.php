...
<head>
    ...
    <link rel="stylesheet" href="../../SRC/CSS/admin/projects_user.css">
...
<body>
    ...
    require_once("../../controlador/config_admin/mostrar_proyectos_user.php");
    ...
    <div class='row container-fluid'>
        <h2 class='col offset-1' id='tusProyectos'><u>Proyectos de:</u> <b><?php mostrarNombreUsuario($_GET['idUser']) ?></b> </h2>
    </div>

    <?php
    
    mostrarProyectosUserAdmin($_GET['idUser']);

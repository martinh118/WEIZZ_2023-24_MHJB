...
function mostrarConfigUsuarios()
{
    ...
    foreach ($allUsers as $user) {
        ...
        $html .=  "<button class='accionInfoUser userOption' type='button' data-bs-toggle='modal' data-bs-target='#infoUsuario' data-id=\"" . $user['ID'] . "\" data-nombre=\"" . $user['usuario'] . "\" data-fecha='" . $user['created_date'] . "'\" data-lastsession=\"" . $user['last_session'] . "\"><img src='../../SRC/imagenes_web/info.png' class='iconUser bd-highlight p-2' alt='boton ver info usuarios'></button>";
        $html .= "<a href='../../vista/admin/projects_user.php?idUser=" . $user["ID"] ."' class='userOption'>" . '<img src="../../SRC/imagenes_web/folder.png" class="iconUser bd-highlight p-2" alt="boton ver proyectos usuario">' . '</a>';

...
function mostrarConfigUsuarios()
{
    ...
    foreach ($allUsers as $user) {
        ...
        $html .= '<a href="">'.'<img src="../../SRC/imagenes_web/info.png" class="iconUser bd-highlight p-2" alt="boton ver info usuarios">'.'</a>';
        $html .= '<a href="">'.'<img src="../../SRC/imagenes_web/folder.png" class="iconUser bd-highlight p-2" alt="boton ver proyectos usuario">'.'</a>';
        $html .= '<a href="">'.'<img src="../../SRC/imagenes_web/pencil.png" class="iconUser bd-highlight p-2" alt="boton editar usuario">'.'</a>';
